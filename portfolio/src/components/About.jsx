...
function About() {
    return (
        <div className='h-full flex flex-col'>
            ...
            <div className='flex flex-col items-center gap-y-5 xl:gap-y-0 xl:flex-row xl:justify-center w-full h-[90%] md:h-[90%] md:my-auto xl:gap-x-20'>
                <div className='w-[300px] h-[300px] md:w-[500px] md:h-[500px] xl:w-[470px] xl:h-[470px] bg-slate-200 rounded-xl'>
                    img
                </div>

                <div className='w-full md:w-[90%] xl:w-1/2 h-1/2 md:h-[50%] xl:h-[80%] flex flex-col gap-y-5 text-justify xl:mt-11'>
                    <div className='w-[150px] h-[100px] md:h-[100px] xl:h-[100px] border-2 rounded-xl bg-slate-200/70 shadow flex flex-col items-center justify-around mx-auto'>
                    ...
                    <button className='w-[45%] md:w-[25%] py-4 px-2 md:p-3 xl:py-5 xl:px-3 xl:ml-8 mx-auto xl:mx-0 bg-black/70 rounded-xl text-white shadow-lg flex items-center justify-evenly'>Download CV  <TbNews size={'20px'}/> </button>
                </div>
            </div>
        </div>
    )
